        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-lg text-slate-400 max-w-xl">
              Turn your waste materials, furniture parts, metal scraps, and appliances into earnings. Adama City's verified MERN stack managed platform.
            </p>
          ...
          <div className="lg:col-span-5 hidden lg:block">
            ...
            >
              <div className="flex items-center justify-between border-b border-slate-800 pb-4 mb-4">
                <span className="text-sm font-bold text-slate-400">Featured Material Depot</span>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-extrabold text-slate-900 sm:text-4xl">The Managed Marketplace Model</h2>
            <p className="mt-4 text-lg text-slate-500">
              Unlike standard sites, we manage order validation, payment safety, courier delivery, and seller payouts to keep transactions risk-free.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="flex flex-col items-center text-center p-4">
              ...
              <h3 className="font-bold text-slate-900 text-base mb-2">Seller Lists & Approvals</h3>
              <p className="text-sm text-slate-500 leading-relaxed">
                Sellers upload items. Administrators review and approve listings to maintain platform quality.
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-4">
              ...
              <h3 className="font-bold text-slate-900 text-base mb-2">Secure Ethiopian Payment</h3>
              <p className="text-sm text-slate-500 leading-relaxed">
                Buyers purchase using Chapa, Telebirr, or Bank Transfer. Funds are securely escrowed.
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-4">
              ...
              <h3 className="font-bold text-slate-900 text-base mb-2">Platform Delivery</h3>
              <p className="text-sm text-slate-500 leading-relaxed">
                Our logistics staff coordinates pickup and delivers items directly in Adama.
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-4">
              ...
              <h3 className="font-bold text-slate-900 text-base mb-2">Seller Payout Trigger</h3>
              <p className="text-sm text-slate-500 leading-relaxed">
                Payout is released to the seller only after successful, confirmed delivery is completed.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="bg-slate-50 border border-slate-200/60 p-8 rounded-2xl flex items-start gap-4">
            ...
            <div>
              <h3 className="font-bold text-slate-950 text-lg mb-2">Escrow Protected</h3>
              <p className="text-sm text-slate-500 leading-relaxed">
                Payments remain escrowed by our marketplace. Sellers are credited only after delivery confirmation. Refund process resolves disputes.
              </p>
            </div>
          </div>
          <div className="bg-slate-50 border border-slate-200/60 p-8 rounded-2xl flex items-start gap-4">
            ...
            <div>
              <h3 className="font-bold text-slate-950 text-lg mb-2">Managed Logistics</h3>
              <p className="text-sm text-slate-500 leading-relaxed">
                Our staff picks up items from sellers and delivers directly to buyers, solving transportation overhead in Adama City.
              </p>
            </div>
          </div>
          <div className="bg-slate-50 border border-slate-200/60 p-8 rounded-2xl flex items-start gap-4">
            ...
            <div>
              <h3 className="font-bold text-slate-950 text-lg mb-2">Configurable Commission</h3>
              <p className="text-sm text-slate-500 leading-relaxed">
                We handle currency localization and charge a small commission to maintain operation, payout processing, and delivery staff incentives.
              </p>
            </div>
          </div>
        </div>
