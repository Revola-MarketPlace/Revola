        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 p-1.5 pr-4 rounded-2xl bg-slate-900/90 border border-orange-500/40 shadow-lg shadow-orange-500/10">
              ...
              <div className="flex items-center gap-1.5 text-sm font-black text-white">
                <span>
                  ...
                  <span className="text-orange-400">vola</span>
                </span>
            ...
            <p className="text-lg text-slate-400 max-w-xl">
              ...
              appliances into cash. Buy and sell locally in Adama — fast, safe,
              and verified.
            </p>
          ...
          <div className="lg:col-span-5 hidden lg:block">
            ...
            >
              ...
              <Link
                to={
                  featuredProducts[0]
                    ? `/products/${featuredProducts[0]._id}`
                    : "/products"
                }
                ...
                <div className="space-y-4">
                  <div className="aspect-video w-full rounded-xl bg-slate-850 overflow-hidden relative">
                    <img
                      ...
                      onError={(e) => {
                        ...
                        target.onerror = null;
                        target.src = getMaterialFallbackImage(
                          featuredProducts[0]?.name,
                          featuredProducts[0]?.category?.name,
                        );
                      }}
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-500 mt-1">
                      Location:{" "}
                      {featuredProducts[0]?.location?.subCity || "Kebele 02"},{" "}
                      {featuredProducts[0]?.location?.city || "Adama"}
                    </div>
                    <div className="flex items-center justify-between mt-4">
                      <span className="text-orange-400 font-extrabold text-lg">
                        {featuredProducts[0]?.price || 450} ETB{" "}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="mt-4 text-lg text-slate-500">
              We take care of everything — from verifying listings to handling
              payments and delivering your order right to your door in Adama.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="flex flex-col items-center text-center p-4">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Sellers list their usable materials with photos and a price. Our
                team reviews each listing before it goes live.
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-4">
              <span className="bg-primary-100 text-primary-800 w-12 h-12 rounded-xl flex items-center justify-center font-bold text-lg shadow-inner mb-4">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Buyers pay via Telebirr or Bank Transfer. Your money is held
                safely until the item is delivered.
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-4">
              <span className="bg-primary-100 text-primary-800 w-12 h-12 rounded-xl flex items-center justify-center font-bold text-lg shadow-inner mb-4">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Our team picks up the item from the seller and delivers it to
                the buyer's address in Adama — no hassle.
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-4">
              <span className="bg-primary-100 text-primary-800 w-12 h-12 rounded-xl flex items-center justify-center font-bold text-lg shadow-inner mb-4">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Once the buyer confirms they received the item, the seller is
                paid. Simple and transparent for everyone.
              </p>
            </div>
          </div>
        </div>
                  ...
                  <div className="aspect-square bg-slate-100 relative overflow-hidden">
                    <img
                      src={
                        ...
                        getMaterialFallbackImage(
                          product.name,
                          product.materialType?.name || product.category?.name,
                        )
                      }
                      alt={product.name}
                      className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="bg-slate-50 border border-slate-200/60 p-8 rounded-2xl flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                We hold your payment until the item arrives safely. If something
                goes wrong, our team steps in to resolve it and issue a refund.
              </p>
            </div>
          </div>
          <div className="bg-slate-50 border border-slate-200/60 p-8 rounded-2xl flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                We pick up from the seller and drop off at your address in
                Adama. No need to arrange your own transport.
              </p>
            </div>
          </div>
          <div className="bg-slate-50 border border-slate-200/60 p-8 rounded-2xl flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                We charge a small service fee to keep the platform running.
                Sellers know exactly what they earn before posting.
              </p>
            </div>
          </div>
        </div>
