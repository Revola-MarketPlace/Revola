      ...
      try {
        ...
        if (response.data?.success && response.data?.status === "PAID") {
          setVerificationResult({
            status: "PAID",
            message:
              "Payment confirmed by Chapa Gateway! Your order has been placed.",
          ...
          setVerificationResult({
            ...
            message:
              ...
              "Chapa reported this transaction as incomplete or failed.",
            order: response.data?.order,
          });
        }
      } catch (err: any) {
        ...
        const errMsg =
          ...
          "Could not verify transaction with Chapa servers.";
        setVerificationResult({
          status: "FAILED",
          message: errMsg,
        });
          ...
          <div className="py-12 flex flex-col items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1 max-w-xs mx-auto">
                Communicating with Chapa gateway to confirm your payment
                receipt. Please do not close this window.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                Your order has been verified and sent to sellers for
                preparation.
              </p>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1 max-w-sm mx-auto">
                {verificationResult.message ||
                  "The Chapa payment was not completed or was cancelled."}
              </p>
            </div>
            ...
            <div className="p-4 bg-amber-50 rounded-2xl border border-amber-200 text-left flex items-start gap-3">
              ...
              <div className="text-xs text-amber-800">
                ...
                Your order remains in pending status until payment is confirmed
                by Chapa. You can retry checkout at any time.
              </div>
            </div>
