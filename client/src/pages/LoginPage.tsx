    ...
    <div className="flex-1 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-slate-50">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-xl border border-slate-200">
        ...
        <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl mt-6 text-xs text-slate-500 space-y-1">
          ...
          <p>• Admin: <code className="bg-slate-200 px-1 py-0.5 rounded">admin@marketplace.com</code> / <code className="bg-slate-200 px-1 py-0.5 rounded">AdminPass123</code></p>
          <p>• Staff (Logistics): <code className="bg-slate-200 px-1 py-0.5 rounded">staff.logistics@marketplace.com</code> / <code className="bg-slate-200 px-1 py-0.5 rounded">StaffPass123</code></p>
          <p>• Seller: <code className="bg-slate-200 px-1 py-0.5 rounded">seller1@marketplace.com</code> / <code className="bg-slate-200 px-1 py-0.5 rounded">SellerPass123</code></p>
          <p>• Buyer: <code className="bg-slate-200 px-1 py-0.5 rounded">buyer1@marketplace.com</code> / <code className="bg-slate-200 px-1 py-0.5 rounded">BuyerPass123</code></p>
        </div>
      </div>
    </div>
  );
