...
const MainLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [activePolicy, setActivePolicy] = useState<
    "TERMS" | "ESCROW" | "SELLER_GUIDELINES" | "ABOUT" | null
  >(null);
    ...
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors duration-200">
      ...
      <footer className="bg-slate-950 text-slate-400 py-14 border-t border-slate-850">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            ...
            <p className="text-sm text-slate-400 max-w-xs leading-relaxed">
              Revola — The premier marketplace for reclaimed construction
              materials, scrap metals, plastics, and industrial equipment.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-6 border-t border-slate-800/80 text-center text-xs text-slate-500">
          &copy; {new Date().getFullYear()} Revola Marketplace. All rights
          reserved.
        </div>
      </footer>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-lg font-black tracking-tight text-white">
                      ...
                      {activePolicy === "SELLER_GUIDELINES" &&
                        "Seller Listing & Payout Guidelines"}
                    </h3>
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-orange-50 border border-orange-200 rounded-xl text-orange-950 text-sm flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span>
                          Revola is Adama City's premier circular economy
                          marketplace dedicated to buying, selling, and reusing
                          usable materials, structural timber, reclaimed steel,
                          scrap metals, plastics, and appliances.
                        </span>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600 mt-1">
                        Construction projects and workshops produce high volumes
                        of reusable materials that often end up in landfills.
                        Revola connects local contractors, scrap depots,
                        merchants, and builders in Adama to circulate usable
                        surplus materials at affordable prices.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600 mt-1">
                        When buyers order on Revola, funds are securely held in
                        escrow. Our verified logistics drivers pick up the
                        materials from local Adama depots and deliver them
                        directly to your work site. Sellers only receive payouts
                        after the buyer verifies receipt.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600 mt-1">
                        Bole, Aba Geda, Goro, Boku, Kebele 02, Kebele 03, Kebele
                        04, Industry Zone, and Wonji Road with real-time route
                        tracking and fair localized delivery fees.
                      </p>
                    </div>
                  </div>
                )}
                {activePolicy === "TERMS" && (
                  <div className="space-y-4">
                    <div className="p-3.5 bg-amber-50 border border-amber-200 rounded-xl text-amber-900 text-xs flex items-center gap-2.5">
                      ...
                      <span>
                        Welcome to AdaMaterials. By registering or trading on
                        the platform, you agree to these legal and operational
                        terms.
                      </span>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600 mt-1">
                        AdaMaterials is a managed marketplace dedicated to
                        recycling, repurposing, and trading usable materials
                        (wood pallets, structural steel beams, scrap metals,
                        plastics, and used industrial equipment) across Adama
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600 mt-1">
                        Users must provide accurate contact information. All
                        payments must be routed through authorized Chapa payment
                        gateway. Offline cash transactions without platform
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600 mt-1">
                        Sellers must hold legitimate legal ownership of all
                        listed items. Stolen goods, hazardous chemical wastes,
                        biological refuse, and counterfeit items are strictly
                        forbidden.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600 mt-1">
                        Deliveries within Adama City are calculated dynamically
                        based on distance zones and bulk item quantities.
                      </p>
                    </div>
                  </div>
                )}
                ...
                {activePolicy === "ESCROW" && (
                  <div className="space-y-4">
                    <div className="p-3.5 bg-emerald-50 border border-emerald-200 rounded-xl text-emerald-900 text-xs flex items-center gap-2.5">
                      ...
                      <span>
                        100% Guaranteed Escrow: Your money is never sent to the
                        seller until you receive your order in good condition.
                      </span>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600 mt-1">
                        When you pay via Chapa, funds are held in secure escrow.
                        The seller cannot withdraw these funds yet.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600 mt-1">
                        When the courier delivers the materials to your site in
                        Adama, you inspect the materials (grade, dimensions, and
                        quantity).
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600 mt-1">
                        Only after staff logistics verifies the handover and
                        marks the order as{" "}
                        <strong className="text-emerald-700 font-bold">
                          DELIVERED
                        </strong>{" "}
                        do the seller payouts become eligible for withdrawal.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600 mt-1">
                        If the delivered material is damaged, missing, or
                        materially misrepresented by the seller, AdaMaterials
                        holds the funds and executes a full refund.
                      </p>
                    </div>
                  </div>
                )}
                ...
                {activePolicy === "SELLER_GUIDELINES" && (
                  <div className="space-y-4">
                    <div className="p-3.5 bg-sky-50 border border-sky-200 rounded-xl text-sky-900 text-xs flex items-center gap-2.5">
                      ...
                      <span>
                        Follow these standards to maximize sales and ensure
                        immediate payout approval on AdaMaterials.
                      </span>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600 mt-1">
                        Accurately select the material condition:{" "}
                        <em>Brand New</em>, <em>Like New (Refurbished)</em>,{" "}
                        <em>Used (Functional)</em>, or{" "}
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600 mt-1">
                        Upload clear, well-lit photos showing actual items and
                        any visible wear. Specify precise dimensions, lengths,
                        or estimated weights.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600 mt-1">
                        All prices must be in Ethiopian Birr (ETB). A
                        transparent <strong>10% marketplace commission</strong>{" "}
                        is deducted upon successful delivery to support payment
                        verification and dispatch operations.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600 mt-1">
                        Keep materials stacked and ready for dispatch. Once
                        delivered to the buyer, your payout status changes to{" "}
                        <strong className="text-sky-700 font-bold">
                          ELIGIBLE
                        </strong>{" "}
                        and is transferred directly to your bank account.
                      </p>
                    </div>
                  </div>
                )}
