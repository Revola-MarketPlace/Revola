...
const connectDB = async () => {
  ...
  try {
    ...
    console.warn(
      "⚠️ Primary MongoDB connection failed. Reason:",
      error.message,
    );
    console.log(
      "🔄 Fallback: Initializing development-only in-memory MongoDB database... 🔌",
    );
    ...
    try {
      ...
      console.log(
        "🌱 Programmatically seeding mock database with demo accounts & materials...",
      );
      await seedData(true);
      console.log(
        "🎉 Seeding completed in memory database! System is ready to test.",
      );
    } catch (memError) {
