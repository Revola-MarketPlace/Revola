...
const dbUri =
  process.env.MONGO_URI || "mongodb://127.0.0.1:27017/managed-marketplace";
  ...
  try {
    ...
    const categoriesData = [
      ...
      },
      {
        ...
        description: "Usable second-hand clothes, textiles, and fabrics",
      },
      {
        name: "Household Items",
        description: "General household scrap, usable items, decorations",
      },
      {
        name: "Kitchen Items",
        description: "Pots, pans, containers, and kitchen utensils",
      },
      {
        name: "Books & Education",
        description: "Used textbooks, novels, paper scrap",
      },
      {
        name: "Tools & Equipment",
        description: "Construction and repair tools, motors, wires",
      },
      {
        name: "Baby & Kids",
        description: "Toys, cribs, clothing for children",
      },
      {
        name: "Sports & Fitness",
        description: "Bicycles, weights, outdoor usable gear",
      },
    ...
    const materialsData = [
      {
        name: "Plastic",
        description: "PET bottles, containers, structural plastic",
      },
      {
        name: "Metal",
        description: "Scrap iron, steel bars, copper wire, aluminum",
      },
      {
        name: "Wood",
        description: "Pallets, logs, lumber, broken furniture parts",
      },
      ...
      {
        name: "Electronic",
        description: "Circuits, components, scrap appliances",
      },
      {
        name: "Mixed Material",
        description: "Complex products with multiple materials combined",
      },
    ...
    const productsData = [
      ...
      },
      {
        ...
        description:
          "Large bale of sorted and washed PET plastic bottles. Ready for processing or shredding.",
        price: 1500,
        quantity: 5,
      ...
      },
      {
        ...
        description:
          "Authentic Bosch electric drill, corded. Missing bits, but the motor is running strong.",
        price: 1800,
        quantity: 1,
      ...
      },
      {
        ...
        description:
          "Bundle of Grade 11 and 12 Maths textbooks. Minor wear on covers, but complete pages inside.",
        price: 300,
        quantity: 15,
      ...
      },
      {
        ...
        description:
          "Stripped high-purity copper wires. Weighs approximately 12kg in total.",
        price: 3200,
        quantity: 1,
        category: toolsCat._id,
        materialType: metalMat._id,
